...
if __name__ == '__main__':
    ...
    info_str += ("\n")
    info_str += ("\n")
    info_str += ("| app                | Code(Bytes)         | RAM(Bytes)          |\n")
    info_str += ("| ------------------ | ------------------- | ------------------- |\n")
    ...
    for app in app_sets:
        ...
        info_str += ("|%20s|%21s|%21s|\n" % (app, elf_size_info.code_size, elf_size_info.data_size+elf_size_info.bss_size))
